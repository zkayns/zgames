...
function Tetris(controller) {
    ...
    this.setup = ()=>{
	    ...
	    continueButton = new Button({image: TEXTURE_INDEX["button_continue"], x: 235, y: 150});
	    restartButton = new Button({image: TEXTURE_INDEX["button_restart"], x: 235, y: 200});
...
window.onload = ()=>{
    ...
    Object.keys(TEXTURE_INDEX).forEach(key=>jaws.assets.add(TEXTURE_INDEX[key]));
